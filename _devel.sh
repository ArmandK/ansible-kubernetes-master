#!/bin/sh
mkdir -p roles
git clone https://github.com/armandk/ansible-role-kubernetes-docker.git roles/armandk.docker
git clone https://github.com/armandk/ansible-role-kubernetes-docker-registry.git roles/armandk.docker-registry
